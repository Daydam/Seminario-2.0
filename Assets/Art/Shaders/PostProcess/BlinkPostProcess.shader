	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 lerpResult18 = lerp( tex2DNode61 , _LinesColor , ( ( tex2D( _SpeedLines, panner7 ) * ( distance( uv04 , float2( 0.5,0.5 ) ) + 0.1 ) ) * _LinesIntensity ));
...
/*ASEBEGIN
Version=16700
-96;133;1352;694;59.6303;112.7656;1.598553;True;False
Node;AmplifyShaderEditor.CommentaryNode;23;-850.823,-422.6575;Float;False;285;303;;1;5;Center of screen;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;5;-800.823,-372.6575;Float;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-1094.024,296.8127;Float;False;Constant;_RadialGradient;RadialGradient;4;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;1240.762,542.3727;Float;False;Property;_Activation;Activation;4;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=427FAA053FBD316BC1462753DD3188B66D4EEC08
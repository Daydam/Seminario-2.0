...
#define _CollapsePosition_arr Drone_Body
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 lerpResult12_g5 = lerp( float3( 0,0,0 ) , ( ( ase_worldPos + ( 1.0 - _CollapsePosition_Instance ) ) + float3(-1,-1,-1) ) , ( saturate( pow( ( distance( ase_worldPos , _CollapsePosition_Instance ) / _Size ) , _Falloff ) ) - 1.0 ));
			float4 transform15_g5 = mul(unity_WorldToObject,float4( lerpResult12_g5 , 0.0 ));
			v.vertex.xyz += transform15_g5.xyz;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_cast_1 = (i.texcoord_0.x).xxxx;
...
/*ASEBEGIN
Version=13101
7;29;1352;692;2934.683;820.5681;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;25;-477.9168,173.4003;Float;False;BestPlayerRim;13;;6;1;0;FLOAT;0.0;False;1;COLOR
...
Node;AmplifyShaderEditor.FunctionNode;22;-93.79565,1011.847;Float;False;VertexCollapse;2;;5;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4
...
ASEEND*/
//CHKSM=AA8BB497D325BF2C49B206C152FC8530F6248F74
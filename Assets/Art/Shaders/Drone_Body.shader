...
#define _CollapsePosition_arr Drone_Body
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 lerpResult12_g9 = lerp( float3( 0,0,0 ) , ( ( ase_worldPos + ( 1.0 - _CollapsePosition_Instance ) ) + float3(-1,-1,-1) ) , ( saturate( pow( ( distance( ase_worldPos , _CollapsePosition_Instance ) / _Size ) , _Falloff ) ) - 1.0 ));
			float4 transform15_g9 = mul(unity_WorldToObject,float4( lerpResult12_g9 , 0.0 ));
			v.vertex.xyz += transform15_g9.xyz;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = saturate( ( tex2D( _PlayerColorTexture, uv_PlayerColorTexture ) * _PlayerColor_Instance ) ).xyz;
			...
			float4 temp_output_21_0 = ( ( ( tex2D( _LifeRamp, fbuv28 ) * tex2D( _LifeEmission, uv_LifeEmission ) ) + ( tex2D( _DefEmission, uv_DefEmission ) * _SkillStateColor ) ) * 5.0 );
			o.Emission = temp_output_21_0.xyz;
...
/*ASEBEGIN
Version=13101
7;29;1352;692;1186.434;954.317;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;40;-890.9768,-648.6498;Float;True;Global;_PlayerColorTexture;PlayerColorTexture;13;0;Assets/Art/Textures/Beetledrone_Paint.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.ColorNode;41;-840.9768,-451.6498;Float;False;InstancedProperty;_PlayerColor;PlayerColor;14;0;0,0,0,0;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-460.1199,-513.1437;Float;False;2;2;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-232.8223,94.757;Float;False;2;2;0;FLOAT4;0.0;False;1;COLOR;0.0,0,0,0;False;1;FLOAT4
Node;AmplifyShaderEditor.SaturateNode;43;-208.3944,-467.0978;Float;False;1;0;FLOAT4;0.0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.FunctionNode;25;-477.9168,173.4003;Float;False;BestPlayerRim;13;;10;1;0;FLOAT;0.0;False;1;COLOR
Node;AmplifyShaderEditor.RangedFloatNode;27;-742.4413,261.0564;Float;False;InstancedProperty;_IsBest;IsBest;12;0;0;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.FunctionNode;22;-93.79565,1011.847;Float;False;VertexCollapse;2;;9;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4
...
Node;AmplifyShaderEditor.SamplerNode;1;-898.3989,-868.9595;Float;True;Property;_Albedo;Albedo;0;0;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-425.7419,-767.8185;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR
...
ASEEND*/
//CHKSM=AEC5086185367DECEA84D83021EA4D1F2F6D4B73